...
System.out.println(nextAwaitingStep);		
		...
		if(onBehalfof2.contains(UpNext) || onBehalfof2.equalsIgnoreCase(UpNext)) {Boxes(driver, Enter1);}
		else if(UpNext == "Default") {Boxes(driver, Enter1);}
		...
		if(driver.findElements(By.xpath("//*[text()='Awaiting Action']")).size()==0) {
			...
			multipleAwaitingActions(driver, Employee, task, Enter1);
...
public static void multipleAwaitingActions(WebDriver driver, String Employee, String task, ArrayList<String>enter12) throws InterruptedException
		{
			 WebDriverWait wait = new WebDriverWait(driver, 25);
			   Actions a=new Actions(driver);
...
public static void Boxes(WebDriver driver, ArrayList<String>enter12) throws InterruptedException
		{
...
public static void SupervisoryOrganization(WebDriver driver, String Efield, String Efield2) throws InterruptedException, IOException
{
	   WebDriverWait wait = new WebDriverWait(driver, 25);
	   Actions a=new Actions(driver);
	   
	   String SupervisoryOrganization = inbox.getExcelData(Efield, "Field", Efield2).get(0);
	   
	   String[] Supfield1= SupervisoryOrganization.split("=");
	   ...
	   if(selectedItem.equalsIgnoreCase(Supinput)) {}   
		   ...
		   String[] SplitfieldInput= SupervisoryOrganization.split("=");
