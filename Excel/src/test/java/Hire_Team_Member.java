...
Login.credentials(driver, "Hire");

StartProxy.TeamMember(driver, "Hire");

task = Task.EnterTask(driver, "Hire Team Member");

inbox.SupervisoryOrganization(driver, "Hire", "Supervisory Organization");

Employee = inbox.input(driver, "Hire", "Pre-Hire");
                                                                                                                                                                         driver.findElement(By.xpath("//*[@title = 'OK']")).click();



input(driver);                                                                                                                        
Thread.sleep(2000); driver.findElement(By.xpath("//*[@title = 'Submit']")).click(); wait.until(ExpectedConditions.invisibilityOf(driver.findElement(By.xpath("//*[@title = 'Submit']")))); 

inbox(driver, "Hire", Employee, "Hire");
...
public static void input(WebDriver driver) throws InterruptedException, IOException 
	   {
	
	Enter1 = inbox.getExcelData("Hire", "Title", "Job Details");
...
public static void inbox(WebDriver driver, String Efield, String Employee,  String task) throws InterruptedException, IOException 
{
...
//inbox.input(driver, "Hire", "Hire Date");

//inbox.input(driver, "Hire", "Reason");

//inbox.input(driver, "Hire", "Team Member Type");

//inbox.input(driver, "Hire", "Job Profile");

//inbox.input(driver, "Hire", "Time Type");

//inbox.input(driver, "Hire", "Location");
