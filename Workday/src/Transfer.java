...
public class Transfer {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		StartProxy.TeamMember(driver, "Luke Hansen (1486554)");
		...
		Thread.sleep(1000);
		EmployeeChangeJob = inbox.input(driver, "Worker=Moses Walker (1549557)");
		...
		Thread.sleep(1500);
		inbox.input(driver, "When do you want this change to take effect?=04/20/2020");
		
		//ChangeJob Type
		ChangeJob = ChangeJob(driver, "Demotion", "Decrease in Responsibility");
			
		//Who will be the manager after this change?
		ManagerChangeJob = inbox.input(driver, "Who will be the manager after this change?=Luke Hansen (1486554)");
		
		//Which team will this person be on after this change?
		inbox.SupervisoryOrganization1(driver, "Luke Hansen", "Which team will this person be on after this change?=ARB 06854 Team (Luke Hansen (1486554))");

		//Where will this person be located after this change?
		inbox.input(driver, "Where will this person be located after this change?=ARB 06854 TROLLEY ROAD");
		
		//Do you want to use the next pay period?
		inbox.input(driver, "Do you want to use the next pay period?=UnCheck");
		driver.findElement(By.xpath("//button[@title = 'Start']")).click();
		
		Boxes1(driver,      "Position=JRARB748",
				            "Job Profile:Job Profile=Team Member&Job Title=Team Member",				            
				            "Location Details:Location=BWW 0685 Leavenworth, KS",
				            "Administrative:Team Member Type=Regular&Time Type=Part time&Pay Rate=Hourly",
				            "Company:Company=ARB USA ARG Reso	urces LLC",
				            "Cost Center:Cost Center=11006854 TROLLEY ROAD",
				            "Hourly:Amount=8.00");
...
public static String ChangeJob(WebDriver driver, String ChangeJob, String Type)
	   {
	Actions a=new Actions(driver);
...
public static void Onboarding(WebDriver driver, String... Enter) throws InterruptedException 
		{
...
public static void Boxes1(WebDriver driver, String Position, String...Enter) throws InterruptedException
{
