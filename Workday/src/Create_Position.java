...
SupervisoryOrganization(driver, "HRIS (Jen Christy (1547682))");

searchBox(driver, "Position Request Reason", "New Position-Budgeted");

inputBox(driver, "Job Posting Title", "General Manager");

inputBox(driver, "Number of Positions", "2");

Calendar.Date(driver, "Availability Date", "February 2020", "3");

Calendar.Date(driver, "Earliest Hire Date", "December 2020", "30");

searchBox(driver, "Job Family", "Buffalo Wild Wings");

searchBox(driver, "Job Profile", "General Manager BWW");

searchBox(driver, "Location", "SDI 2250 Jenks, OK (W Main)");

searchBox(driver, "Time Type", "Full time");

searchBox(driver, "Worker Type", "Team Member");

searchBox(driver, "Worker Sub-Type", "Regular");

driver.findElement(By.xpath("//*[text() = 'Submit']")).click();

inbox(driver, "Cost Center=HRIS" );
